...
class ClientDocumentFields(models.Model):
    ...
    reference = fields.Char(
        ...
        copy=False,
        default='New',
        help='Unique document reference'
    )
    ...
    file_size = fields.Float(
        ...
        store=True,
        help='Size of the uploaded file in megabytes'
    )
    ...
    expiry_date = fields.Date(
        string='Expiry Date',
        help='Document expiry date if applicable'
    )
    ...
    active = fields.Boolean(
        ...
        default=True,
        tracking=True,
        help='Set to false to archive the document'
    )
    ...
    department_id = fields.Many2one(
        'hr.department',
        string='Department',
        help='Department responsible for this document'
    )

    # Additional Information
    notes = fields.Html(
        string='Notes',
        help='Rich-text notes about the document'
    )
    ...
    summary = fields.Text(
        string='Summary',
        help='Brief summary of the document content'
    )

    icon = fields.Binary(
        string='Icon',
        attachment=True,
        help='Document type icon'
    )
    ...
    # Constraints
    _sql_constraints = [
        ('unique_reference', 'unique(reference)', 'Document reference must be unique!')
    ]
